...
export const imageMap: Record<string, string> = {
  ...
  '/assets/pepperoni.png': pepperoniImage,
  '/assets/quattro.png': quattroImage,
  '/assets/vegetarian.png': vegImage,
  '/assets/meat.png': meatImage,
  '/assets/bruschetta.png': bruschettaImage,
  '/assets/garlic.png': garlicImage,
  '/assets/mozzarella.png': mozzImage,
  '/assets/caesar.png': caesarImage,
  '/assets/caprese.png': capreseImage,
